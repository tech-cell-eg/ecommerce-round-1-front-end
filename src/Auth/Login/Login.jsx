          ...
          <form className="flex flex-col justify-center items-start space-y-4 w-[85%] m-auto h-full">
            ...
            <div className="flex flex-col w-full space-y-1">
              ...
              <input
                type="email"
                id="email"
                className="rounded-lg border-2 border-gray-600 py-2 px-2"
                required
              />
            </div>
            <div className="flex flex-col w-full space-y-1">
              ...
              <div>
                ...
                >
                  <input
                    ...
                    name="remember-me"
                    value="remember-me"
                    className="appearance-none relative h-4 w-4 border border-gray-400 rounded bg-gray-200 checked:bg-black checked:text-white checked:before:content-['✓'] checked:before:absolute checked:before:text-sm checked:before:font-semibold  checked:before:text-white flex items-center justify-center "
                  />
