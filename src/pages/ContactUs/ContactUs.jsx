...
export default function ContactUs() {
  ...
  <section className='min-h-screen pt-4 pb-10 flex flex-col items-center justify-center bg-[#F5F5F8] relative overflow-hidden'>
  ...
  <h2 className='text-bold text-3xl py-2 border-b w-fit border-black  '>Get in touch</h2>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10  px-4 w-full py-6 ">
       ...
       <div>
        <textarea id='message' name="message" placeholder="Your Message" className='form-control' rows="6"  onChange={formik.handleChange} value={formik.values.message}></textarea>
