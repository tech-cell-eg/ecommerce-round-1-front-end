...
![Screenshot](https://github.com/hbenl/vscode-mocha-test-adapter/raw/HEAD/img/screenshot.png)
...
* Run / Debug your tests using the ![Run](https://github.com/hbenl/vscode-mocha-test-adapter/raw/HEAD/img/run.png) / ![Debug](https://github.com/hbenl/vscode-mocha-test-adapter/raw/HEAD/img/debug.png) icons in the Test Explorer or the CodeLenses in your test file
