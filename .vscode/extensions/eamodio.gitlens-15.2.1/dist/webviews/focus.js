...
`,ai=class extends lit_element_s{constructor(){super(),Object.entries(this.constructor.dependencies).forEach((([e,t])=>{this.constructor.define(e,t)}))}emit(e,t){const o=new CustomEvent(e,Jo({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(o),o}static define(e,t=this,o={}){const i=customElements.get(e);if(!i)return void customElements.define(e,class extends t{},o);let n=" (unknown version)",r=n;"version"in t&&t.version&&(n=" v"+t.version),"version"in i&&i.version&&(r=" v"+i.version)}};ai.version="2.15.1",ai.dependencies={},Ko([lo()],ai.prototype,"dir",2),Ko([lo()],ai.prototype,"lang",2);const li=Math.min,ci=Math.max,di=Math.round,pi=Math.floor,hi=e=>({x:e,y:e}),ui={left:"right",right:"left",bottom:"top",top:"bottom"},gi={start:"end",end:"start"};function fi(e,t,o){return ci(e,li(t,o))}function mi(e,t){return"function"==typeof e?e(t):e}function bi(e){return e.split("-")[0]}function vi(e){return e.split("-")[1]}function yi(e){return"x"===e?"y":"x"}function wi(e){return"y"===e?"height":"width"}function ki(e){return["top","bottom"].includes(bi(e))?"y":"x"}function _i(e){return yi(ki(e))}function xi(e){return e.replace(/start|end/g,(e=>gi[e]))}function $i(e){return e.replace(/left|right|bottom|top/g,(e=>ui[e]))}function Ci(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function Si(e){const{x:t,y:o,width:i,height:n}=e;return{width:i,height:n,top:o,left:t,right:t+i,bottom:o+n,x:t,y:o}}function Ai(e,t,o){let{reference:i,floating:n}=e;const r=ki(t),a=_i(t),l=wi(a),c=bi(t),d="y"===r,p=i.x+i.width/2-n.width/2,h=i.y+i.height/2-n.height/2,u=i[l]/2-n[l]/2;let g;switch(c){case"top":g={x:p,y:i.y-n.height};break;case"bottom":g={x:p,y:i.y+i.height};break;case"right":g={x:i.x+i.width,y:h};break;case"left":g={x:i.x-n.width,y:h};break;default:g={x:i.x,y:i.y}}switch(vi(t)){case"start":g[a]-=u*(o&&d?-1:1);break;case"end":g[a]+=u*(o&&d?-1:1)}return g}async function Ri(e,t){var o;void 0===t&&(t={});const{x:i,y:n,platform:r,rects:a,elements:l,strategy:c}=e,{boundary:d="clippingAncestors",rootBoundary:p="viewport",elementContext:h="floating",altBoundary:u=!1,padding:g=0}=mi(t,e),f=Ci(g),m=l[u?"floating"===h?"reference":"floating":h],b=Si(await r.getClippingRect({element:null==(o=await(null==r.isElement?void 0:r.isElement(m)))||o?m:m.contextElement||await(null==r.getDocumentElement?void 0:r.getDocumentElement(l.floating)),boundary:d,rootBoundary:p,strategy:c})),v="floating"===h?{x:i,y:n,width:a.floating.width,height:a.floating.height}:a.reference,y=await(null==r.getOffsetParent?void 0:r.getOffsetParent(l.floating)),w=await(null==r.isElement?void 0:r.isElement(y))&&await(null==r.getScale?void 0:r.getScale(y))||{x:1,y:1},k=Si(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:v,offsetParent:y,strategy:c}):v);return{top:(b.top-k.top+f.top)/w.y,bottom:(k.bottom-b.bottom+f.bottom)/w.y,left:(b.left-k.left+f.left)/w.x,right:(k.right-b.right+f.right)/w.x}}function Pi(e){return Di(e)?(e.nodeName||"").toLowerCase():"#document"}function Ei(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function Ti(e){var t;return null==(t=(Di(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function Di(e){return e instanceof Node||e instanceof Ei(e).Node}function Oi(e){return e instanceof Element||e instanceof Ei(e).Element}function Li(e){return e instanceof HTMLElement||e instanceof Ei(e).HTMLElement}function Mi(e){return"undefined"!=typeof ShadowRoot&&(e instanceof ShadowRoot||e instanceof Ei(e).ShadowRoot)}function Fi(e){const{overflow:t,overflowX:o,overflowY:i,display:n}=Hi(e);return/auto|scroll|overlay|hidden|clip/.test(t+i+o)&&!["inline","contents"].includes(n)}function zi(e){return["table","td","th"].includes(Pi(e))}function Ii(e){return[":popover-open",":modal"].some((t=>{try{return e.matches(t)}catch(e){return!1}}))}function Bi(e){const t=Ni(),o=Oi(e)?Hi(e):e;return"none"!==o.transform||"none"!==o.perspective||!!o.containerType&&"normal"!==o.containerType||!t&&!!o.backdropFilter&&"none"!==o.backdropFilter||!t&&!!o.filter&&"none"!==o.filter||["transform","perspective","filter"].some((e=>(o.willChange||"").includes(e)))||["paint","layout","strict","content"].some((e=>(o.contain||"").includes(e)))}function Ni(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}function Ui(e){return["html","body","#document"].includes(Pi(e))}function Hi(e){return Ei(e).getComputedStyle(e)}function Wi(e){return Oi(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function ji(e){if("html"===Pi(e))return e;const t=e.assignedSlot||e.parentNode||Mi(e)&&e.host||Ti(e);return Mi(t)?t.host:t}function qi(e){const t=ji(e);return Ui(t)?e.ownerDocument?e.ownerDocument.body:e.body:Li(t)&&Fi(t)?t:qi(t)}function Vi(e,t,o){var i;void 0===t&&(t=[]),void 0===o&&(o=!0);const n=qi(e),r=n===(null==(i=e.ownerDocument)?void 0:i.body),a=Ei(n);return r?t.concat(a,a.visualViewport||[],Fi(n)?n:[],a.frameElement&&o?Vi(a.frameElement):[]):t.concat(n,Vi(n,[],o))}function Gi(e){const t=Hi(e);let o=parseFloat(t.width)||0,i=parseFloat(t.height)||0;const n=Li(e),r=n?e.offsetWidth:o,a=n?e.offsetHeight:i,l=di(o)!==r||di(i)!==a;return l&&(o=r,i=a),{width:o,height:i,$:l}}function Qi(e){return Oi(e)?e:e.contextElement}function Ji(e){const t=Qi(e);if(!Li(t))return hi(1);const o=t.getBoundingClientRect(),{width:i,height:n,$:r}=Gi(t);let a=(r?di(o.width):o.width)/i,l=(r?di(o.height):o.height)/n;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}const Yi=hi(0);function Ki(e){const t=Ei(e);return Ni()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:Yi}function Zi(e,t,o,i){void 0===t&&(t=!1),void 0===o&&(o=!1);const n=e.getBoundingClientRect(),r=Qi(e);let a=hi(1);t&&(i?Oi(i)&&(a=Ji(i)):a=Ji(e));const l=function(e,t,o){return void 0===t&&(t=!1),!(!o||t&&o!==Ei(e))&&t}(r,o,i)?Ki(r):hi(0);let c=(n.left+l.x)/a.x,d=(n.top+l.y)/a.y,p=n.width/a.x,h=n.height/a.y;if(r){const e=Ei(r),t=i&&Oi(i)?Ei(i):i;let o=e,n=o.frameElement;for(;n&&i&&t!==o;){const e=Ji(n),t=n.getBoundingClientRect(),i=Hi(n),r=t.left+(n.clientLeft+parseFloat(i.paddingLeft))*e.x,a=t.top+(n.clientTop+parseFloat(i.paddingTop))*e.y;c*=e.x,d*=e.y,p*=e.x,h*=e.y,c+=r,d+=a,o=Ei(n),n=o.frameElement}}return Si({width:p,height:h,x:c,y:d})}function Xi(e){return Zi(Ti(e)).left+Wi(e).scrollLeft}function en(e,t,o){let i;if("viewport"===t)i=function(e,t){const o=Ei(e),i=Ti(e),n=o.visualViewport;let r=i.clientWidth,a=i.clientHeight,l=0,c=0;if(n){r=n.width,a=n.height;const e=Ni();(!e||e&&"fixed"===t)&&(l=n.offsetLeft,c=n.offsetTop)}return{width:r,height:a,x:l,y:c}}(e,o);else if("document"===t)i=function(e){const t=Ti(e),o=Wi(e),i=e.ownerDocument.body,n=ci(t.scrollWidth,t.clientWidth,i.scrollWidth,i.clientWidth),r=ci(t.scrollHeight,t.clientHeight,i.scrollHeight,i.clientHeight);let a=-o.scrollLeft+Xi(e);const l=-o.scrollTop;return"rtl"===Hi(i).direction&&(a+=ci(t.clientWidth,i.clientWidth)-n),{width:n,height:r,x:a,y:l}}(Ti(e));else if(Oi(t))i=function(e,t){const o=Zi(e,!0,"fixed"===t),i=o.top+e.clientTop,n=o.left+e.clientLeft,r=Li(e)?Ji(e):hi(1);return{width:e.clientWidth*r.x,height:e.clientHeight*r.y,x:n*r.x,y:i*r.y}}(t,o);else{const o=Ki(e);i={...t,x:t.x-o.x,y:t.y-o.y}}return Si(i)}function tn(e,t){const o=ji(e);return!(o===t||!Oi(o)||Ui(o))&&("fixed"===Hi(o).position||tn(o,t))}function on(e,t,o){const i=Li(t),n=Ti(t),r="fixed"===o,a=Zi(e,!0,r,t);let l={scrollLeft:0,scrollTop:0};const c=hi(0);if(i||!i&&!r)if(("body"!==Pi(t)||Fi(n))&&(l=Wi(t)),i){const e=Zi(t,!0,r,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else n&&(c.x=Xi(n));return{x:a.left+l.scrollLeft-c.x,y:a.top+l.scrollTop-c.y,width:a.width,height:a.height}}function nn(e){return"static"===Hi(e).position}function rn(e,t){return Li(e)&&"fixed"!==Hi(e).position?t?t(e):e.offsetParent:null}function sn(e,t){const o=Ei(e);if(Ii(e))return o;if(!Li(e)){let t=ji(e);for(;t&&!Ui(t);){if(Oi(t)&&!nn(t))return t;t=ji(t)}return o}let i=rn(e,t);for(;i&&zi(i)&&nn(i);)i=rn(i,t);return i&&Ui(i)&&nn(i)&&!Bi(i)?o:i||function(e){let t=ji(e);for(;Li(t)&&!Ui(t);){if(Bi(t))return t;if(Ii(t))return null;t=ji(t)}return null}(e)||o}const an={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:o,offsetParent:i,strategy:n}=e;const r="fixed"===n,a=Ti(i),l=!!t&&Ii(t.floating);if(i===a||l&&r)return o;let c={scrollLeft:0,scrollTop:0},d=hi(1);const p=hi(0),h=Li(i);if((h||!h&&!r)&&(("body"!==Pi(i)||Fi(a))&&(c=Wi(i)),Li(i))){const e=Zi(i);d=Ji(i),p.x=e.x+i.clientLeft,p.y=e.y+i.clientTop}return{width:o.width*d.x,height:o.height*d.y,x:o.x*d.x-c.scrollLeft*d.x+p.x,y:o.y*d.y-c.scrollTop*d.y+p.y}},getDocumentElement:Ti,getClippingRect:function(e){let{element:t,boundary:o,rootBoundary:i,strategy:n}=e;const r=[..."clippingAncestors"===o?Ii(t)?[]:function(e,t){const o=t.get(e);if(o)return o;let i=Vi(e,[],!1).filter((e=>Oi(e)&&"body"!==Pi(e))),n=null;const r="fixed"===Hi(e).position;let a=r?ji(e):e;for(;Oi(a)&&!Ui(a);){const t=Hi(a),o=Bi(a);o||"fixed"!==t.position||(n=null),(r?!o&&!n:!o&&"static"===t.position&&n&&["absolute","fixed"].includes(n.position)||Fi(a)&&!o&&tn(e,a))?i=i.filter((e=>e!==a)):n=t,a=ji(a)}return t.set(e,i),i}(t,this._c):[].concat(o),i],a=r[0],l=r.reduce(((e,o)=>{const i=en(t,o,n);return e.top=ci(i.top,e.top),e.right=li(i.right,e.right),e.bottom=li(i.bottom,e.bottom),e.left=ci(i.left,e.left),e}),en(t,a,n));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}},getOffsetParent:sn,getElementRects:async function(e){const t=this.getOffsetParent||sn,o=this.getDimensions,i=await o(e.floating);return{reference:on(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:o}=Gi(e);return{width:t,height:o}},getScale:Ji,isElement:Oi,isRTL:function(e){return"rtl"===Hi(e).direction}};function ln(e,t,o,i){void 0===i&&(i={});const{ancestorScroll:n=!0,ancestorResize:r=!0,elementResize:a="function"==typeof ResizeObserver,layoutShift:l="function"==typeof IntersectionObserver,animationFrame:c=!1}=i,d=Qi(e),p=n||r?[...d?Vi(d):[],...Vi(t)]:[];p.forEach((e=>{n&&e.addEventListener("scroll",o,{passive:!0}),r&&e.addEventListener("resize",o)}));const h=d&&l?function(e,t){let o,i=null;const n=Ti(e);function r(){var e;clearTimeout(o),null==(e=i)||e.disconnect(),i=null}return function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),r();const{left:d,top:p,width:h,height:u}=e.getBoundingClientRect();if(l||t(),!h||!u)return;const g={rootMargin:-pi(p)+"px "+-pi(n.clientWidth-(d+h))+"px "+-pi(n.clientHeight-(p+u))+"px "+-pi(d)+"px",threshold:ci(0,li(1,c))||1};let f=!0;function m(e){const t=e[0].intersectionRatio;if(t!==c){if(!f)return a();t?a(!1,t):o=setTimeout((()=>{a(!1,1e-7)}),1e3)}f=!1}try{i=new IntersectionObserver(m,{...g,root:n.ownerDocument})}catch(e){i=new IntersectionObserver(m,g)}i.observe(e)}(!0),r}(d,o):null;let u,g=-1,f=null;a&&(f=new ResizeObserver((e=>{let[i]=e;i&&i.target===d&&f&&(f.unobserve(t),cancelAnimationFrame(g),g=requestAnimationFrame((()=>{var e;null==(e=f)||e.observe(t)}))),o()})),d&&!c&&f.observe(d),f.observe(t));let m=c?Zi(e):null;return c&&function t(){const i=Zi(e);!m||i.x===m.x&&i.y===m.y&&i.width===m.width&&i.height===m.height||o();m=i,u=requestAnimationFrame(t)}(),o(),()=>{var e;p.forEach((e=>{n&&e.removeEventListener("scroll",o),r&&e.removeEventListener("resize",o)})),null==h||h(),null==(e=f)||e.disconnect(),f=null,c&&cancelAnimationFrame(u)}}const cn=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var o,i;const{x:n,y:r,placement:a,middlewareData:l}=t,c=await async function(e,t){const{placement:o,platform:i,elements:n}=e,r=await(null==i.isRTL?void 0:i.isRTL(n.floating)),a=bi(o),l=vi(o),c="y"===ki(o),d=["left","top"].includes(a)?-1:1,p=r&&c?-1:1,h=mi(t,e);let{mainAxis:u,crossAxis:g,alignmentAxis:f}="number"==typeof h?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...h};return l&&"number"==typeof f&&(g="end"===l?-1*f:f),c?{x:g*p,y:u*d}:{x:u*d,y:g*p}}(t,e);return a===(null==(o=l.offset)?void 0:o.placement)&&null!=(i=l.arrow)&&i.alignmentOffset?{}:{x:n+c.x,y:r+c.y,data:{...c,placement:a}}}}},dn=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:o,y:i,placement:n}=t,{mainAxis:r=!0,crossAxis:a=!1,limiter:l={fn:e=>{let{x:t,y:o}=e;return{x:t,y:o}}},...c}=mi(e,t),d={x:o,y:i},p=await Ri(t,c),h=ki(bi(n)),u=yi(h);let g=d[u],f=d[h];if(r){const e="y"===u?"bottom":"right";g=fi(g+p["y"===u?"top":"left"],g,g-p[e])}if(a){const e="y"===h?"bottom":"right";f=fi(f+p["y"===h?"top":"left"],f,f-p[e])}const m=l.fn({...t,[u]:g,[h]:f});return{...m,data:{x:m.x-o,y:m.y-i}}}}},pn=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var o,i;const{placement:n,middlewareData:r,rects:a,initialPlacement:l,platform:c,elements:d}=t,{mainAxis:p=!0,crossAxis:h=!0,fallbackPlacements:u,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...b}=mi(e,t);if(null!=(o=r.arrow)&&o.alignmentOffset)return{};const v=bi(n),y=ki(l),w=bi(l)===l,k=await(null==c.isRTL?void 0:c.isRTL(d.floating)),_=u||(w||!m?[$i(l)]:function(e){const t=$i(e);return[xi(e),t,xi(t)]}(l)),x="none"!==f;!u&&x&&_.push(...function(e,t,o,i){const n=vi(e);let r=function(e,t,o){const i=["left","right"],n=["right","left"],r=["top","bottom"],a=["bottom","top"];switch(e){case"top":case"bottom":return o?t?n:i:t?i:n;case"left":case"right":return t?r:a;default:return[]}}(bi(e),"start"===o,i);return n&&(r=r.map((e=>e+"-"+n)),t&&(r=r.concat(r.map(xi)))),r}(l,m,f,k));const C=[l,..._],S=await Ri(t,b),A=[];let R=(null==(i=r.flip)?void 0:i.overflows)||[];if(p&&A.push(S[v]),h){const e=function(e,t,o){void 0===o&&(o=!1);const i=vi(e),n=_i(e),r=wi(n);let a="x"===n?i===(o?"end":"start")?"right":"left":"start"===i?"bottom":"top";return t.reference[r]>t.floating[r]&&(a=$i(a)),[a,$i(a)]}(n,a,k);A.push(S[e[0]],S[e[1]])}if(R=[...R,{placement:n,overflows:A}],!A.every((e=>e<=0))){var P,E;const e=((null==(P=r.flip)?void 0:P.index)||0)+1,t=C[e];if(t)return{data:{index:e,overflows:R},reset:{placement:t}};let o=null==(E=R.filter((e=>e.overflows[0]<=0)).sort(((e,t)=>e.overflows[1]-t.overflows[1]))[0])?void 0:E.placement;if(!o)switch(g){case"bestFit":{var T;const e=null==(T=R.filter((e=>{if(x){const t=ki(e.placement);return t===y||"y"===t}return!0})).map((e=>[e.placement,e.overflows.filter((e=>e>0)).reduce(((e,t)=>e+t),0)])).sort(((e,t)=>e[1]-t[1]))[0])?void 0:T[0];e&&(o=e);break}case"initialPlacement":o=l}if(n!==o)return{reset:{placement:o}}}return{}}}},hn=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){const{placement:o,rects:i,platform:n,elements:r}=t,{apply:a=()=>{},...l}=mi(e,t),c=await Ri(t,l),d=bi(o),p=vi(o),h="y"===ki(o),{width:u,height:g}=i.floating;let f,m;"top"===d||"bottom"===d?(f=d,m=p===(await(null==n.isRTL?void 0:n.isRTL(r.floating))?"start":"end")?"left":"right"):(m=d,f="end"===p?"top":"bottom");const b=g-c.top-c.bottom,v=u-c.left-c.right,y=li(g-c[f],b),w=li(u-c[m],v),k=!t.middlewareData.shift;let _=y,x=w;if(h?x=p||k?li(w,v):v:_=p||k?li(y,b):b,k&&!p){const e=ci(c.left,0),t=ci(c.right,0),o=ci(c.top,0),i=ci(c.bottom,0);h?x=u-2*(0!==e||0!==t?e+t:ci(c.left,c.right)):_=g-2*(0!==o||0!==i?o+i:ci(c.top,c.bottom))}await a({...t,availableWidth:x,availableHeight:_});const C=await n.getDimensions(r.floating);return u!==C.width||g!==C.height?{reset:{rects:!0}}:{}}}},un=e=>({name:"arrow",options:e,async fn(t){const{x:o,y:i,placement:n,rects:r,platform:a,elements:l,middlewareData:c}=t,{element:d,padding:p=0}=mi(e,t)||{};if(null==d)return{};const h=Ci(p),u={x:o,y:i},g=_i(n),f=wi(g),m=await a.getDimensions(d),b="y"===g,v=b?"top":"left",y=b?"bottom":"right",w=b?"clientHeight":"clientWidth",k=r.reference[f]+r.reference[g]-u[g]-r.floating[f],_=u[g]-r.reference[g],x=await(null==a.getOffsetParent?void 0:a.getOffsetParent(d));let C=x?x[w]:0;C&&await(null==a.isElement?void 0:a.isElement(x))||(C=l.floating[w]||r.floating[f]);const S=k/2-_/2,A=C/2-m[f]/2-1,R=li(h[v],A),P=li(h[y],A),E=R,T=C-m[f]-P,D=C/2-m[f]/2+S,O=fi(E,D,T),L=!c.arrow&&null!=vi(n)&&D!==O&&r.reference[f]/2-(D<E?R:P)-m[f]/2<0,M=L?D<E?D-E:D-T:0;return{[g]:u[g]+M,data:{[g]:O,centerOffset:D-O-M,...L&&{alignmentOffset:M}},reset:L}}}),gn=(e,t,o)=>{const i=new Map,n={platform:an,...o},r={...n.platform,_c:i};return(async(e,t,o)=>{const{placement:i="bottom",strategy:n="absolute",middleware:r=[],platform:a}=o,l=r.filter(Boolean),c=await(null==a.isRTL?void 0:a.isRTL(t));let d=await a.getElementRects({reference:e,floating:t,strategy:n}),{x:p,y:h}=Ai(d,i,c),u=i,g={},f=0;for(let o=0;o<l.length;o++){const{name:r,fn:m}=l[o],{x:b,y:v,data:y,reset:w}=await m({x:p,y:h,initialPlacement:i,placement:u,strategy:n,middlewareData:g,rects:d,platform:a,elements:{reference:e,floating:t}});p=null!=b?b:p,h=null!=v?v:h,g={...g,[r]:{...g[r],...y}},w&&f<=50&&(f++,"object"==typeof w&&(w.placement&&(u=w.placement),w.rects&&(d=!0===w.rects?await a.getElementRects({reference:e,floating:t,strategy:n}):w.rects),({x:p,y:h}=Ai(d,u,c))),o=-1)}return{x:p,y:h,placement:u,strategy:n,middlewareData:g}})(e,t,{...n,platform:r})},fn=wo(class extends directive_i{constructor(e){if(super(e),e.type!==fo||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const o=e.element.classList;for(const e of this.st)e in t||(o.remove(e),this.st.delete(e));for(const e in t){const i=!!t[e];i===this.st.has(e)||this.nt?.has(e)||(i?(o.add(e),this.st.add(e)):(o.remove(e),this.st.delete(e)))}return Jt}});function mn(e){return vn(e)}function bn(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function vn(e){for(let t=e;t;t=bn(t))if(t instanceof Element&&"none"===getComputedStyle(t).display)return null;for(let t=bn(e);t;t=bn(t)){if(!(t instanceof Element))continue;const e=getComputedStyle(t);if("contents"!==e.display){if("static"!==e.position||"none"!==e.filter)return t;if("BODY"===t.tagName)return t}}return null}var yn=class extends ai{constructor(){super(...arguments),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect();let o=0,i=0,n=0,r=0,a=0,l=0,c=0,d=0;this.placement.includes("top")||this.placement.includes("bottom")?e.top<t.top?(o=e.left,i=e.bottom,n=e.right,r=e.bottom,a=t.left,l=t.top,c=t.right,d=t.top):(o=t.left,i=t.bottom,n=t.right,r=t.bottom,a=e.left,l=e.top,c=e.right,d=e.top):e.left<t.left?(o=e.right,i=e.top,n=t.left,r=t.top,a=e.right,l=e.bottom,c=t.left,d=t.bottom):(o=t.right,i=t.top,n=e.left,r=e.top,a=t.right,l=t.bottom,c=e.left,d=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${i}px`),this.style.setProperty("--hover-bridge-top-right-x",`${n}px`),this.style.setProperty("--hover-bridge-top-right-y",`${r}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${a}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${d}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||function(e){return null!==e&&"object"==typeof e&&"getBoundingClientRect"in e&&(!("contextElement"in e)||e instanceof Element)}(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.start()}start(){this.anchorEl&&(this.cleanup=ln(this.anchorEl,this.popup,(()=>{this.reposition()})))}async stop(){return new Promise((e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame((()=>e()))):e()}))}reposition(){if(!this.active||!this.anchorEl)return;const e=[cn({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(hn({apply:({rects:e})=>{const t="width"===this.sync||"both"===this.sync,o="height"===this.sync||"both"===this.sync;this.popup.style.width=t?`${e.reference.width}px`:"",this.popup.style.height=o?`${e.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(pn({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(dn({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(hn({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${t}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(un({element:this.arrowEl,padding:this.arrowPadding}));const t="absolute"===this.strategy?e=>an.getOffsetParent(e,mn):an.getOffsetParent;gn(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:Yo(Jo({},an),{getOffsetParent:t})}).then((({x:e,y:t,middlewareData:o,placement:i})=>{const n="rtl"===getComputedStyle(this).direction,r={top:"bottom",right:"left",bottom:"top",left:"right"}[i.split("-")[0]];if(this.setAttribute("data-current-placement",i),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){const e=o.arrow.x,t=o.arrow.y;let i="",a="",l="",c="";if("start"===this.arrowPlacement){const o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";i="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",a=n?o:"",c=n?"":o}else if("end"===this.arrowPlacement){const o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";a=n?"":o,c=n?o:"",l="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(c="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":"",i="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":""):(c="number"==typeof e?`${e}px`:"",i="number"==typeof t?`${t}px`:"");Object.assign(this.arrowEl.style,{top:i,right:a,bottom:l,left:c,[r]:"calc(var(--arrow-size-diagonal) * -1)"})}})),requestAnimationFrame((()=>this.updateHoverBridge())),this.emit("sl-reposition")}render(){return Qt`
...
`;var cr=Object.defineProperty,dr=Object.getOwnPropertyDescriptor,pr=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?dr(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&cr(t,o,r),r};let hr=class extends lit_element_s{firstUpdated(){"alert"===this.appearance&&queueMicrotask((()=>this.button.focus()))}render(){if(null==this.state)return void(this.hidden=!0);this.hidden=!1;const e="alert"===(this.appearance??"alert")?"alert":Yt;switch(this.state){case nr.VerificationRequired:return Qt`
					<p class="actions">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${ur(L.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							class="inline"
							appearance="${e}"
							href="${ur(L.PlusValidate,this.source)}"
				...
				`;case nr.Free:return Qt`
					<gl-button
						appearance="${e}"
						href="${ur(L.PlusStartPreviewTrial,this.source)}"
						>Continue</gl-button
					>
					<p>
						...
						<a href="${ur(L.PlusSignUp,this.source)}"
							>start your free 7-day Pro trial</a
						>
						or
						<a href="${ur(L.PlusLogin,this.source)}" title="Sign In">sign in</a>.
					</p>
				`;case nr.FreePreviewTrialExpired:return Qt`
					<gl-button
						appearance="${e}"
						href="${ur(L.PlusSignUp,this.source)}"
				...
				`;case nr.FreePlusTrialExpired:return Qt` <gl-button
						appearance="${e}"
						href="${ur(L.PlusUpgrade,this.source)}"
					...
					<p class="special">Special: <b>1st seat of Pro is now 50%+ off.</b><br /></p>`;case nr.FreePlusTrialReactivationEligible:return Qt`
					<gl-button
						appearance="${e}"
						href="${ur(L.PlusReactivateProTrial,this.source)}"
						>Continue</gl-button
					>
					<p>
		...
		>`;return this.state===nr.Paid?Qt`<div class="popup-header">${e}</div>`:this.cloud?this.preview?Qt`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires a paid plan for use on privately-hosted repos</span>
					...
					<gl-tooltip hoist content="Show Account view">
						<a href="${Rr(L.ShowAccountView,void 0)}"
					...
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Rr(L.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${Rr(L.PlusValidate,this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Rr(L.PlusReactivateProTrial,this.source)}"
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${Rr(L.PlusSignUp,this.source)}"
				>Start 7-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${Rr(L.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){return Qt`<div class="actions">
			${e??Yt}
			<gl-button
				appearance="primary"
				density="tight"
				href="${Rr(L.PlusUpgrade,this.source)}"
				>Upgrade to Pro</gl-button
			>
